...
- `docs/` - documentation for the project, including data and methods
- `src/` - source code used for crop yield forecasting research
- `results/` - generated outputs, summaries, and research results
